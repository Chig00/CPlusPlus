...
const DeckCode AGGRO_DECK(
	"Aggro",
	"A deck featuring Hot Rodder, Vacuumancer, Diver, and Cloud Surfer.\n"
	"Switch your fighters round to hit hard with Hot Rodder!\nUse Vacuumancer "
	"to pick out important targets to strike!\nTrade Diver's invinciblity to hit "
	"harder for a turn and use Cloud Surfer to strike twice in a turn!",
	{
		1, // Driver
		1, // Racer
		1, // Hot Rodder
...
const DeckCode SOLO_DECK(
	"Solo Deck",
	"A deck featuring Pyrotechnician, Miner, Swimmer, and Wind Runner.\n"
	"Use the Energy Acceleration ability that your fighters to have to quickly "
	"attach all of the elemental energy cards in your deck to fighters.\nThen use "
	"Lock Picker to return the energy to your hand to fuel your Pyrotechnician!",
	{
		0, // Driver
		0, // Racer
		0, // Hot Rodder
