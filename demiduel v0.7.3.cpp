...
#define ENERGY_VALUE_STRING std::to_string(               \
	adaptable ? energy[page * PAGE_COUNT + i].get_value() \
	: energy[page * PAGE_COUNT + i].get_value(element)    \
)
...
constexpr int CLERIC_HEALTH = 1200;
...
constexpr const char* CLERIC_ABILITY_DESCRIPTION =
	"At the end of your turn, heal 75 damage from each of your fighters."
;
...
constexpr int VACUUMANCER_HEALTH = 1100;
...
// Banisher
//{
// Banish trash, damage over time (power with void)
//}
...
// Cultist
//{
// Targeted heal (void powered), use attack of fighter in void
//}
//}
...
// Apprentice
//{
// Can use energy of Sensei's Chosen's element, basic attack
//}

// Sensei's Chosen
//{
// Can use energy of Apprentice's element, flip for power
//}

// Ninja
//{
// Combo attack with Samurai, old Magic Missiless
//}

// Samurai
//{
// Combo attack with Ninja, flip twice for cripple (no actions for target next turn)
//}
//}
//}
...
const DeckCode AGGRO_DECK(
	"Aggro",
	"A deck featuring Hot Rodder, Vacuumancer, Pyrotechnician, and Cloud Surfer.\n"
	"Switch your fighters round to hit hard with Hot Rodder!\nUse Vacuumancer "
	"to pick out important targets to strike!\nLoad energy onto Pyrotechnician "
	"to obliterate the opposition and use Cloud Surfer to strike twice in a turn!",
	{
		1, // Driver
		1, // Racer
		1, // Hot Rodder
...
const DeckCode CONTROL_DECK(
	"Control",
	"A deck featuring Astronaut, Cleric, Excavator, and Diver.\n"
	"Use Astronaut to keep your fighters switching, so Cleric's healing "
	"is maximised.\nDiver's invinciblity can be used to stall for a turn and "
	"Excavator can clear away your opponent's energy!",
	{
		1, // Driver
		0, // Racer
		0, // Hot Rodder
...
const DeckCode MILL_DECK(
	"Mill Deck",
	"A deck featuring Monster Trucker and Pyromancer.\n"
	"Discard both decks with Pyromancer, Miller, and Arsonist!\nThen, use Glutton "
	"to shuffle all of the energy you discarded back into your deck!\nMonster Trucker's "
	"high health and reliable healing can help you stall for time.",
	{
		1, // Driver
		0, // Racer
		0, // Hot Rodder
...
const DeckCode COMBO_DECK(
	"Combo Deck",
	"A deck featuring Pirate, Warlock, Diver, and Cloud Surfer.\n"
	"Maniac boosts damage, but discards the hand.\nBy playing multiple Maniac cards "
	"with Warlock and trash searching cards, Cloud Surfer can deal a huge amount of "
	"damage to all of opposing fighters!\nDiver can be used to stall or hit hard "
	"and Pirate helps to set up the combo.\nBanker can be used to protect cards in hand.",
	{
		1, // Driver
		0, // Racer
		0, // Hot Rodder
...
constexpr int DECK_CODE_COUNT = 5;
