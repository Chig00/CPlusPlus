...
//{
#define ADAPTABLE_CONDITION (effect_search(ADAPTABILITY_EFFECT))
...
constexpr int EXPLANATION_COUNT = 6;
...
#define EFFECT_CONDITIONS(X) (                            \
	...
	: static_cast<bool>(ADAPTABLE_CONDITION)              \
)
//}
...
constexpr const char* DIRT_BIKER_ABILITY_DESCRIPTION =
	...
	"your deck and heal 75 damage from this fighter."
;
...
constexpr const char* PYROMANCER_ABILITY_DESCRIPTION =
	"Once a turn, you may discard the top 2 cards of each player's deck."
;
...
// Void Energy
//{
constexpr const char* TWIN_ENERGY_NAME = "Void Energy";
...
constexpr int TWIN_ENERGY_VALUE = 3000;
//}
...
class Fighter: public Card {
	public:
		...
		void view_energy(
			...
			bool adaptable = effect_search(ADAPTABILITY_EFFECT);
		...
		int energy_value() const noexcept {
			...
			if (effect_search(ADAPTABILITY_EFFECT)) {
...
constexpr int FIGHTER_COUNT = 14;
...
constexpr int SUPPORTER_COUNT = 28;
...
const DeckCode AGGRO_DECK(
	"Aggro Deck",
	"An aggressive deck featuring Hot Rodder, Monster Trucker, Vacuumancer, and Warlock.",
	{
		2, // Driver
		1, // Racer
		1, // Hot Rodder
...
const DeckCode CONTROL_DECK(
	"Control Deck",
	"A defensive deck featuring Pirate, Astronaut, Cleric, and Pyromancer.",
	{
		2, // Driver
		0, // Racer
		0, // Hot Rodder
...
const DeckCode DRIVER_MAGE_PACKAGE(
	"Driver/Mage Package",
	"Contains 2 copies of Driver and Mage.",
	{
		2, // Driver
		0, // Racer
		0, // Hot Rodder
...
constexpr int DECK_CODE_COUNT = 4;
